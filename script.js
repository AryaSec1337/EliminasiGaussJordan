function initengahan(){
  ...
  async function menuju(){await swals.fire('OK!', 'Kirim jawabannya ke WhatsApp aku, ya!', 'success');window.location = "https://api.whatsapp.com/send?phone=+6287804037106&text=" + pesanwhatsapp;}
